function [t_hist, x_vec_hist, Phi_mtx_hist, i_e, t_e, x_e_vec, Phi_e_mtx] = integrate_pccr4bp(tspan, x_0_vec, params, event_fun)
%==========================================================================
%
...
%
%  t_hist        -   time vector                                      -
%  x_vec_hist   -   state history (N x 4)                             -
%  Phi_mtx_hist -   STM history (N x 4 x 4)                           -
%  t_e          -   event times                                       -
...
%==========================================================================
    ...
    if isempty(event_fun)
        ...
        [t_hist, X_vec_hist] = ode113( ...
            @(t,X) eom_stm_ccr4bp_H(t, X, params), ...
        ...
        x_e_vec = X_e_vec(1:4);
        Phi_e_mtx = reshape(X_e_vec(5:20),4,4);

    end

    % Recover state history
    x_vec_hist = X_vec_hist(:,1:4);
    ...
    for k = 1:N
        Phi_mtx_hist(k,:,:) = reshape(X_vec_hist(k,5:20),4,4);
    end
